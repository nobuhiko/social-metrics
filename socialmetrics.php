	...
	<table class="widefat post fixed smtable" cellspacing="0">
		<thead>
			<tr>
				...
				<th scope="col" id="title6" class="manage-column column-title" >Buffer</th>
				<th scope="col" id="title7" class="manage-column column-title" >LinkedIn</th>
				<th scope="col" id="title8" class="manage-column column-title" >Hatena</th>
			</tr>
		</thead>
		<tbody>
<?php 		while ($recentPosts->have_posts()) : $recentPosts->the_post(); ?>
			<tr>
                ...
                <td ><a data-save-url="<?php the_permalink(); ?>" data-pocket-label="pocket" data-pocket-count="horizontal" class="pocket-btn" data-lang="en"></a></td>
                <td ><a href="http://bufferapp.com/add" class="buffer-add-button" data-text="<?php the_title(); ?>" data-url="<?php the_permalink(); ?>" data-count="horizontal" >Buffer</a></td>
...
<?php		endwhile; ?>
		...
		<tfoot>
			<tr>
				...
				<th scope="col"  class="manage-column column-title" >Buffer</th>
					...
					<div class="pro-features">
						...
						<div id="text-14" class="feature_box even">
							<div class="feature-wrap"><h3 class="feature_title">Export to Excel for Further Analysis</h3>
								<div class="feature_text"><img class="features alignleft" src="http://socialmetricspro.com/wp-content/themes/optimal/images/custom/export-excel.png">Social Metrics Pro lets you export the filtered, sorted data and custom queries to Excel. You値l get data in tab-delimited and comma-separated file formats. You can use Excel or any spreadsheet processor of your choice.
									<p></p><center><a href="http://www.riyaz.net/social-metrics-pro/" target="_blank" class="button-secondary">Learn More</a></center><p></p>
								</div>
							</div>
						</div>
